...
It's something to make people who can't view or read the internet like an average person accessable.

2. Talk about 3 different things you can do to ensure your website is accessible.
Make sure it's color blind friendly.
Use Semantic mark up. 
Make sure you can navigate the page with your keyboard.

3. How would you explain the concept of a variable to someone new to programming?
Something you can put a name on to store information

4. What is the purpose of using functions in code?
To set statements that perform a task or calculate a value.
